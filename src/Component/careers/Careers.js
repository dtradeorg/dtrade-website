...
import { Container, Row, Col, Nav, NavItem, NavLink, TabContent, TabPane } from 'react-bootstrap';
...
function Careers({ match }) {
  ...
  if ('/careers' === location.pathname) require('./careers.css');
              ...
              <div className='row'>
                <Col sm={12}>
                  <div className='content-row'>
                    ...
                    <p>
                      Join us in building the first decentralized exchange for synthetic asset, options and perpetuals
                      trading on Polkadot
                    </p>
                  </div>
                          ...
                          {sample_job_data[activeTab]?.map((item) => {
                            return (
                              <li key={item.learnMore}>
                                ...
                                <Link className='clink' to={`${match.url}/${item.learnMore}`} title='Learn More'>
                                  Learn More
                                </Link>
                              </li>
                            );
