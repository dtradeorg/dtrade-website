      ...
      <Container fluid className='bg'>
        ...
        <Container className='desc'>
          <Row className='text-center'>
            <Col md={12}>
              <h3>
                We're seeking a Backend Developer having proficiency in Node.js to join our team. We encourage people
                who can dive headlong into situations to get things done, set their own direction and feel pride about
                what they create. <br />
                Your primary focus will be the development of all server-side logic, definition and maintenance of the
                central database, and ensuring high performance and responsiveness to requests from the frontend. <br />{' '}
                <br />
        ...
        <Container className='list'>
          ...
          <ul className='p-0'>
            ...
            <li>
              <img src='./assets/images/dot.png' alt='.' className='mr-3' />
              Proficiency with JavaScript and in-depth knowledge of Node.js and its Express framework{' '}
            </li>
            <li>
              <img src='./assets/images/dot.png' alt='.' className='mr-3' />
            ...
            <li>
              ...
              <span className='pl-4'> optimizing output to match the specific platform</span>{' '}
            </li>
            <li>
              <img src='./assets/images/dot.png' alt='.' className='mr-3' />
