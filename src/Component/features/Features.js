    ...
    <div className='feature-div'>
      ...
      <div className='row feature-row '>
        <div className='col-12 col feature-col '>
          <div className='feature-heading'>Accessible</div>
        ...
        <div className='col-12 col feature-col '>
          <div className='feature-heading'>Low Fees</div>
          <div className='feature-body'>
        ...
        <div className='col-12 col feature-col '>
          ...
          <div className='feature-body'>Zero slippage by trading assets backed by a distributed collateral pool</div>
        </div>
      </div>

      <div className='row text-left  imp-disc'>
        <div className='info mt-5'>
          <a rel='nofollow' href='#disclosure-div' className='to-disc-link left'>
