    ...
    <Animated animationIn='fadeIn' animationOut='fadeOut'>
      <div className='row align-items-center justify-content-center'>
        <div className='col-12 justify-content-center text-center tab-sec-mobile'>
          <h3 className='reward-heading text-center'>On-Chain Options</h3>
          ...
          <img className='img-fluid tablet-trade' src='./assets/images/Specs/options.png' alt='On-Chain Options'></img>
        </div>
      </div>
    </Animated>
  );
